...
export const products: Product[] = [
  ...
  },
  {
    ...
    longDescription:
      "Aqua Bulgari captures the essence of Mediterranean serenity. This sophisticated aquatic fragrance opens with bright mandarin and neroli, creating a citrus burst that feels both luxurious and refreshing.\n\nThe heart features petitgrain and rosemary, adding an aromatic, herbal quality that evokes coastal gardens. The base of mineral amber and white tea provides a clean, elegant finish that lingers subtly.\n\nPerfect for the refined gentleman who appreciates understated elegance. Aqua Bulgari is your signature for sophisticated casual wear and warm-weather occasions.",
    image:
      "https://images.unsplash.com/photo-1541643600914-78b084683601?w=800&h=800&fit=crop",
    images: [
      "https://images.unsplash.com/photo-1541643600914-78b084683601?w=800&h=800&fit=crop",
  ...
  },
  {
    ...
    longDescription:
      "Bulgari Extreme epitomizes refined masculinity. This sophisticated fragrance opens with vibrant grapefruit and neroli, creating a fresh, citrusy introduction that feels luxurious and invigorating.\n\nThe heart features green tea, cardamom, and guaiac wood, adding an exotic, spicy dimension that brings complexity and character. The base of amber and musk creates a warm, sensual finish that's perfectly balanced.\n\nCrafted for the discerning gentleman who values quality and sophistication. Bulgari Extreme is your signature for business meetings, formal events, and moments when you want to make a lasting impression.",
    image:
